...
export default function ContractDetail() {
  ...
  console.log('[ContractDetail] DEBUG v2 - contract.is_migrated:', (contract as any).is_migrated, 'manualCorrectionEvents:', manualCorrectionEvents, 'contract.id:', contract.id);
