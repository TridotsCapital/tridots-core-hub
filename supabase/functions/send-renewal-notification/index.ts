...
<head>
  ...
  <title>Tridots Capital - Renovação de Contrato</title>
    ...
    <tr>
      <td align="center" style="padding:40px 20px;">
        <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="max-width:600px;width:100%;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding:0;">
              <img src="https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=600&h=180&fit=crop&crop=center" alt="Tridots Capital" style="width:100%;max-width:600px;height:180px;object-fit:cover;object-position:center;display:block;" />
            </td>
          </tr>
          <!-- Content -->
          <tr>
